$(document).ready(function(spineless) {
    ...
    $(window).load(function() {
        ...
        spineless.scroll_interval = box_height - (box_height % line_height); // 4
        ...
        spineless.content_height = parseInt( $("#ebook").height() ); // 5
        spineless.max_clicks = BookScroll.compute_max_clicks(spineless); // 6
        spineless.anchor = BookScroll.compute_anchor(spineless); // 7
